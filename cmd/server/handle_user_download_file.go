...
func (s *State) handleUserDownloadFile(w http.ResponseWriter, r *http.Request) error {
	id := r.PathValue("id")
	...
	file, err := s.prepareUserDownloadFile(id, name)
...
func (s *State) prepareUserDownloadFile(id, name string) (io.ReadSeekCloser, error) {
