...
func TestPagination(t *testing.T) {
	for _, tc := range []struct {
		...
		},
		{
			...
			res: []template.PaginationView{
				{Number: 1},
				{Number: 2, Link: "myapp?offset=10&limit=10"},
			},
		},
		{
		...
		},
		{
			...
			baseUrl:      "myapp",
			res: []template.PaginationView{
				{Number: 1, Link: "myapp?offset=0&limit=10"},
				{Number: 2},
			},
		},
		{
		...
		},
		{
			...
			res: []template.PaginationView{
				{Number: 1},
				{Number: 2, Link: "myapp?offset=10&limit=10"},
				{Number: 3, Link: "myapp?offset=20&limit=10"},
				{IsPlaceholder: true},
				{Number: 5, Link: "myapp?offset=40&limit=10"},
				{Number: 6, Link: "myapp?offset=50&limit=10"},
				{Number: 7, Link: "myapp?offset=60&limit=10"},
			},
		},
		{
		...
		},
		{
			...
			res: []template.PaginationView{
				...
				{Number: 3, Link: "myapp?offset=20&limit=10"},
				{IsPlaceholder: true},
				{Number: 8, Link: "myapp?offset=70&limit=10"},
				{Number: 9, Link: "myapp?offset=80&limit=10"},
				{Number: 10, Link: "myapp?offset=90&limit=10"},
			},
		},
		{
		...
		},
		{
			...
			res: []template.PaginationView{
				...
				{Number: 10, Link: "myapp?offset=90&limit=10"},
				{Number: 11},
				{Number: 12, Link: "myapp?offset=110&limit=10"},
				{Number: 13, Link: "myapp?offset=120&limit=10"},
				{IsPlaceholder: true},
				{Number: 18, Link: "myapp?offset=170&limit=10"},
				{Number: 19, Link: "myapp?offset=180&limit=10"},
				{Number: 20, Link: "myapp?offset=190&limit=10"},
			},
		},
	} {
